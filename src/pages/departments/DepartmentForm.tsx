...
export const DepartmentForm = () => {
  ...
  useEffect(() => {
    if (urlParams.departmentId) {
      ...
      //   setDepartmentDetails(props.departmentDetails);
    }
  ...
  const formikForm = useFormik({
    ...
    onSubmit: (values: any) => {
      ...
      if (urlParams.departmentId) {
        updateDepartmentsRequest(filteredObject, urlParams.departmentId);
      } else {
        addNewDepartmentsRequest(filteredObject).then((res) => {
