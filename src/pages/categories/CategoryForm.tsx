...
export const CategoryForm = (props: { categoryName: string }) => {
  const formikForm = useFormik({
    initialValues: { category_name: props.categoryName },
        ...
        <div className="w-full p-4 grid grid-cols-1 ">
          <div className="flex flex-col mb-4">
            ...
            <div className="flex flex-col">
              ...
              <InputText
                id="category_name"
                aria-describedby="category_name-help"
                placeholder="Enter a category name"
                className={classNames(
                  { "p-invalid": isFormFieldInvalid("category_name") },
