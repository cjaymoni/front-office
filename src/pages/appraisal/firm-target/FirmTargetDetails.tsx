...
import { IFirmTarget, getFirmTargetsByIdRequest } from "./firmTargetApiRequest";
...
export const FirmTargetDetails = () => {
  const navigate = useNavigate();
  const urlParams = useParams();
  const [firmTargetDetails, setFirmTargetDetails] = useState<IFirmTarget>();
      ...
      <div className="flex justify-between p-2">
        ...
        <div className="flex justify-end">
          <Button
            ...
            onClick={() =>
              navigate(`/firm-targets/${firmTargetDetails?.id}/edit`)
            }
          />
          <Button
            label="Go Back"
