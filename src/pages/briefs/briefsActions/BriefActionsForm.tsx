...
export const BriefActionsForm = () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      fieldName: "cancelled",
      formikForm: formikForm,
      placeholder: "Enter cancellation status",
    },
    {
    ...
    {
      label: "Staffs Assigned",
      fieldType: "text",
      fieldName: "staffs_assigned",
      formikForm: formikForm,
      placeholder: "Enter staffs assigned",
    },
    {
      label: "Participants",
      fieldType: "text",
