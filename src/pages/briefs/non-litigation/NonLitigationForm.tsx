...
export const NonLitigationForm = () => {
  const navigate = useNavigate();
  const targetRef = useRef(null);
  const [isSubmitted, setIsSubmitted] = useState(false);
  const [litigationDetails, setBriefDetails] = useState<IBriefs>();
          ...
          <div className="flex flex-col mb-4">
            ...
            <div className="flex flex-col">
              <DropdownWithCreate
                optionLabel="label"
                optionValue="value"
                value={formikForm.values.brief_id}
                onChange={(e) => {
                  formikForm.setFieldValue("brief_id", e.target.value);
                }}
                placeholder="Select a brief"
                className={classNames(
                  { "p-invalid": isFormFieldInvalid("brief_id") },
