...
import {
  IConsultation,
  addNewConsultationsRequest,
  getConsultationsByIdRequest,
  updateConsultationsRequest,
...
export const ConsultationsForm = () => {
  ...
  const formikForm = useFormik({
    ...
    onSubmit: (values: any) => {
      ...
      if (urlParams.consultationId) {
        updateConsultationsRequest(filteredObject, urlParams.consultationId);
      } else {
        addNewConsultationsRequest(filteredObject).then((res) => {
