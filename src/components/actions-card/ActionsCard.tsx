  ...
  return (
    <div className="h-50 w-full rounded bg-white border  ">
      ...
      <div className="flex items-center justify-between">
        <div className="p-3 text-gray-700 text-lg font-bold">Action Header</div>
        <div className="p-3 flex">
          <button className="text-slate-800 hover:text-[#f59331] mr-1 text-sm bg-white hover:border-[#f59331]  hover:bg-slate-100 border border-[#f59331] rounded-l-lg font-medium px-4 py-2 inline-flex space-x-1 items-center">
            <span>
              <svg
      ...
      <div className="p-3  text-sm italic text-gray-500 flex justify-between">
        <span>
          <i className="pi pi-clock mr-1"></i> Action Date
        </span>
      </div>
