...
export const CardWithBarChartSmall = () => {
  ...
  return (
    <div className="h-full p-4 bg-white rounded-md ">
      <div className="flex justify-between items-center mb-3">
        <div className="flex text-gray-400">Payments</div>
      ...
      <div className="text-left mb-3 text-2xl text-black">6,560</div>
      ...
      <div className="flex flex-row mt-2 text-[14px]">
        <span className="mr-4 text-gray-600">Conversion Rate</span>
