...
import { LegalOpinionCard } from "../cards/legal-opinion-card/LegalOpinionCard";
...
export const LegalOpinionTabComponent = () => {
  ...
  return (
    <div className="w-full bg-gray-100 border-none p-4">
      ...
      <LegalOpinionCard handleEditClick={() => setVisible(true)} />
      <br />
      <LegalOpinionCard handleEditClick={() => setVisible(true)} />

      <Dialog
        header={`Add Legal Opinion `}
        visible={visible}
        style={{ width: "50vw" }}
